...
export type KanbanSceneRoleDetailPanelProps = {
  projectName: string;
...
export function KanbanSceneRoleDetailPanel({
  projectName,
  role,
  projectRoles,
  members,
  onDeleted,
}: KanbanSceneRoleDetailPanelProps) {
  ...
  return (
    <div className="kanban-role-detail">
      ...
      <div className="kanban-role-detail__top">
        <section className="kanban-role-detail__section kanban-role-detail__section--card">
        ...
        <section className="kanban-role-detail__section kanban-role-detail__section--description">
          ...
          {members.map((m) => {
            ...
            return (
              <button
                ...
                type="button"
                className={cn(
                  "kanban-role-detail__actor-tile",
                  checked && "kanban-role-detail__actor-tile--selected",
                )}
                disabled={busy}
