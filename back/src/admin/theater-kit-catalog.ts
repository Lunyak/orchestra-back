...
const LIBRARY: Array<{ assetKey: string; label: string }> = [
  ...
  { assetKey: 'painted-wooden-chair-02', label: 'Крашеный стул 2' },
  { assetKey: 'painted-wooden-nightstand', label: 'Крашеная тумбочка' },
  ...
  { assetKey: 'port-crate', label: 'Портовый ящик' },
